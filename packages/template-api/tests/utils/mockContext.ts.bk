...
import { Atomly } from '@root/types';

// TODO: Create typescript-utils package with these helpful types.
type Omit<T, K extends keyof T> = Pick<T, Exclude<keyof T, K>>

// Or, to omit multiple properties:
type Context = Omit<Atomly.IContext, 'request'|'response'|'database'|'loaders'|'connection'|'fragmentReplacements'>; // Equivalent to: {c: boolean}
