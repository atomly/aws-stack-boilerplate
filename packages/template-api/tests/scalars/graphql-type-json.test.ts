...
import {
  GraphQLJSON,
  GraphQLJSONObject,
} from '../../src/schema/resolvers/scalars/scalars';
...
function createSchema(type: GraphQLScalarType): GraphQLSchema {
    ...
    query: new GraphQLObjectType({
      ...
      fields: {
        value: {
          ...
          resolve: (_obj: unknown, { arg }: { arg: unknown }): unknown => arg,
        },
        rootValue: {
          type,
          resolve: (obj: unknown): unknown => obj,
        },
      },
    }),
    types: [GraphQLInt],
