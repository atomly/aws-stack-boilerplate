// Libraries
import { StripeSupportedCurrencies, User } from '@atomly/surveyshark-collections-lib';
      ...
      try {
        ...
        await session.withTransaction(
          async () => {
            ...
            // Creating the user's document in the SurveyShark DB:
            ...
            // Save Stripe data & references to the SurveySharkDB:
