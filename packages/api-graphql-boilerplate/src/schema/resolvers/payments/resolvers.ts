// Libraries
import { Plan, Customer, Subscription } from '@atomly/entities-lib-boilerplate';
  ...
  Mutation: {
    async createSelfSubscription(
      ...
      if (request.session.userId) {
        ...
        // 6. Save Stripe data & references to the TemplateDB:
    ...
    async updateSelfSubscription(
      ...
      if (request.session.userId) {
        ...
        // 6. If necessary, update Stripe data & references to the TemplateDB:
    ...
    async cancelSelfSubscription(
      ...
      if (request.session.userId) {
        ...
        // 6. Update Stripe data & references to the TemplateDB:
